...
export declare class WebViewer {
     ...
     */
    start(rrd: string | string[] | null, parent: HTMLElement | null, options: WebViewerOptions | null, open_options?: WebViewerOpenOptions | null): Promise<void>;
    /** Internal interface */
     ...
     * @param rrd URLs to `.rrd` files or gRPC connections to our SDK.
     */
    open(rrd: string | string[], options?: WebViewerOpenOptions): void;
    /**
     * Close a recording.
     *
     * The viewer must have been started via {@link WebViewer.start}.
